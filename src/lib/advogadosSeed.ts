 ...
 * aparecer no quadro, e três casos que travam de propósito na liberação de
 * acesso — um sem inscrição conferida, um sem tese e um sem modelo escolhido.
 */
export const ADVOGADOS_SEED: Advogado[] = [
  // --- novo ----------------------------------------------------------------
  a('Silva & Associados', '104238/GO', 'GO', ['polo_passivo'], 'pequeno', 12, 'novo', 'u-closer', 3, 16),
  a('Marques Advocacia', '087611/SP', 'SP', ['vinculo_empregaticio'], 'solo', 6, 'novo', 'u-sdr', 1, 9),
  a('Peixoto Sociedade de Advogados', '221904/MG', 'MG', ['juros_abusivos'], 'medio', 25, 'novo', 'u-closer', 0, 4),
  a('Dra. Helena Prado', '045172/DF', 'DF', ['polo_passivo', 'juros_abusivos'], 'solo', 8, 'novo', 'u-sdr', 2, 21),
  a('Nunes & Barbosa', '133870/PR', 'PR', ['vinculo_empregaticio'], 'pequeno', 10, 'novo', 'u-closer', 6, 6),
  a('Escritório Vasconcelos', '190455/BA', 'BA', ['polo_passivo'], 'medio', 22, 'novo', 'u-sdr', 18, 30),

  // --- em_qualificacao -----------------------------------------------------
  a('Andrade Trabalhista', '076329/SP', 'SP', ['vinculo_empregaticio'], 'medio', 30, 'em_qualificacao', 'u-closer', 2, 24),
  a('Vieira Consumidor', '158802/RJ', 'RJ', ['juros_abusivos'], 'grande', 45, 'em_qualificacao', 'u-closer', 5, 33),
  a('Sorriso Advocacia', '203117/CE', 'CE', ['polo_passivo'], 'solo', 5, 'em_qualificacao', 'u-sdr', 13, 27),
  ...
  a('Castro Advogados', '118460/RS', 'RS', ['polo_passivo', 'vinculo_empregaticio'], 'pequeno', 14, 'em_qualificacao', 'u-closer', 1, 12, { oabConferida: 6 }),

  // --- qualificado ---------------------------------------------------------
  a('Mendonça Previdência', '099274/GO', 'GO', ['polo_passivo'], 'medio', 28, 'qualificado', 'u-closer', 9, 41, { oabConferida: 12 }),
  a('Nova Era Advocacia', '167053/SC', 'SC', ['juros_abusivos'], 'pequeno', 16, 'qualificado', 'u-closer', 4, 29, { oabConferida: 8 }),
  ...
  a('Freitas & Freitas', '241988/PE', 'PE', ['vinculo_empregaticio'], 'grande', 40, 'qualificado', 'u-sdr', 16, 38),
  // Trava de propósito: inscrição conferida, mas nenhuma tese marcada.
  a('Ribeiro Sociedade Individual', '062715/ES', 'ES', [], 'solo', 7, 'qualificado', 'u-sdr', 2, 18, { oabConferida: 5 }),

  // --- acesso_liberado -----------------------------------------------------
  a('Rocha & Teixeira', '145600/MG', 'MG', ['polo_passivo', 'juros_abusivos'], 'medio', 24, 'acesso_liberado', 'u-closer', 3, 52, { oabConferida: 40 }),
  a('Salgado Advocacia', '178322/PA', 'PA', ['vinculo_empregaticio'], 'pequeno', 11, 'acesso_liberado', 'u-closer', 1, 47, { oabConferida: 35 }),
  ...
  // --- ativo ---------------------------------------------------------------
  a('Prev Fácil Advogados', '033901/GO', 'GO', ['polo_passivo', 'vinculo_empregaticio'], 'grande', 60, 'ativo', 'u-cs', 1, 190, { oabConferida: 185, modelo: 'creditos', saldo: 128, usuario: 'u-advogado' }),
  a('Gomes & Cia', '124773/SP', 'SP', ['juros_abusivos'], 'medio', 32, 'ativo', 'u-cs', 3, 145, { oabConferida: 140, modelo: 'creditos', saldo: 41, usuario: 'u-advogado-2' }),
  ...
  // --- desfechos -----------------------------------------------------------
  {
    ...a('Bastos Advocacia', '155208/MT', 'MT', ['polo_passivo'], 'solo', 4, 'perdido', 'u-closer', 22, 60),
    motivoPerda: 'Achou o preço por lead alto para o ticket médio da região.',
  },
  {
    ...a('Lima Consultoria Jurídica', '270311/AM', 'AM', ['juros_abusivos'], 'pequeno', 12, 'recusado', 'u-sdr', 30, 88),
    motivoPerda: 'Inscrição suspensa no momento da conferência.',
  },
  a('Dourado & Filhos', '141007/PB', 'PB', ['vinculo_empregaticio'], 'medio', 20, 'em_pausa', 'u-closer', 25, 75, { oabConferida: 70 }),
];
